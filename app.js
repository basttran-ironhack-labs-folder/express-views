...
// makes files inside "public/" available thourgh our app's domain
app.use(express.static(__dirname + "/public"));

// Use the 'hbs' npm package for your template engine
...
app.get("/playlist", (request, response, next) => {
  ...
  // ("locals" refers to local variables IN THEE HBS FILE)
